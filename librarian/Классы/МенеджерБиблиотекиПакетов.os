...
Функция ПрочитатьОписаниеРепо(Знач ДанныеJSON)
	...
	Репо.Вставить("ЭтоФорк", Репозиторий.Получить("fork"));
	Репо.Вставить("ПутьSSH", Репозиторий.Получить("ssh_url");
	Репо.Вставить("URLДетальнойИнформации", Репозиторий.Получить("url");
